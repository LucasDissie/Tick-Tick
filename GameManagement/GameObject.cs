...
public abstract class GameObject : IGameLoopObject
{
    ...
    private bool screenDependent = true;
    ...
    {
        get { return GlobalPosition - GameEnvironment.Camera.CameraPos; }
    }
    ...
    public virtual bool ScreenDependent
    {
        get { return screenDependent; }
        set { screenDependent = value; }
    }
}